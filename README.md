...
[**Download Kaisola.dmg**](https://github.com/michaelofengend/kaisola/releases/latest/download/Kaisola.dmg) (macOS 13+, Apple Silicon, signed & notarized — [all releases](https://github.com/michaelofengend/kaisola/releases)) and drag Kaisola to Applications. Or install from the terminal:
